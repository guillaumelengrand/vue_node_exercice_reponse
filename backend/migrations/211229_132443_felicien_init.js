export default {
  up: async (q) => {
    ...
    await q.sequelize.query(
      "CREATE TABLE IF NOT EXISTS `users` (`id` CHAR(36) NOT NULL , `phone_number` VARCHAR(30) NOT NULL, `registration_number` VARCHAR(30) NOT NULL, `first_name` VARCHAR(255), `last_name` VARCHAR(255), `last_connected` DATETIME, `eventId` CHAR(36) NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`eventId`) REFERENCES `events` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE) ENGINE=InnoDB;"
    );
    await q.sequelize.query(
